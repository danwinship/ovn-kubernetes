...
func (m *machine) addContainer(container ExternalContainer) error {
	...
	cmd := buildDaemonContainerCmd(container.Name, container.Image, container.CMD)
...
func (o openshift) GetExternalContainerPort() int32 {
	return o.externalContainerPort.allocate()
}

func (o openshift) GetK8HostPort() int32 {
